...
The intern is frozen and sequential. The orchestrator is the knob: **fixed** (top-k keep), **prompted** (thin LLM scorecard), or **learned** (stub). ParallelResearch's async tree is the published ParallelResearch baseline, not this intern.
