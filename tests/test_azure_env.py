...
def test_azure_v1_base_url_appends_openai_v1() -> None:
    assert azure_v1_base_url("https://adobe-cmu.openai.azure.com") == (
        "https://adobe-cmu.openai.azure.com/openai/v1/"
    )
...
def test_azure_env_aliases_openai_compat_vars(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setenv("AZURE_OPENAI_ENDPOINT", "https://adobe-cmu.openai.azure.com/")
...
def test_factory_builds_azure_client(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert client.azure_endpoint == "https://adobe-cmu.openai.azure.com/"
